...
<nav class="navbar bg-body-tertiary">
    <div class="container-fluid">
        ...
        <ul class="menu">
            <li><a class="link-menu" href="loginUtente.html">Login</a></li>
            <li><a class="link-menu" href="contatti.html">Contatti</a></li>
            <li><a class="link-menu" href="registrazione.html">Registrazione</a></li>
        </ul>
    </div>
    <div class="hamburger">
        <span></span>
...
<div class="giochi reveal" id="giochi_db">
    ...
    <ul class="for zoom">
        ...
        <div class="giochi-immagine reveal">
            ...
            <%}%>
            <div class="button">
                <h3>Per aggiungere al carrello devi  prima effettuare il login</h3><br><br><br>
            </div>
            </form>
            </p><br>
        </div>
