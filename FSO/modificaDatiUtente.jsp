...
<head>
  ...
  <link rel="stylesheet" href="css/modificaDati.css">


  <title>ModificaDatiUtente</title>
...
<a class="logo" href="${pageContext.request.contextPath}indexUtente.html">
  <img src="${pageContext.request.contextPath}immagini/logo.jpg" alt="" class="logoimg">
</a>
<nav class="navbar bg-body-tertiary">
  ...
  <h1 class="titolo">MODIFICA I TUOI DATI</h1>
