...
<div class="grande-div reveal">
    ...
    <c:forEach items="${sessionScope.carrello}" var="item">
        <div class="carrello reveal">
            <img src="imagesDB/${item.getImmagine()}.jpg" class="carrello-img"><br>
            <p class="nome-genere-prezzo"> ${item.getNomeProdotto()}, ${item.getGenere()}, ${item.getPrezzoProdotto() - item.getPrezzoScontato()}€<br></p><br>

            <p class="no">${totale = totale + (item.getPrezzoProdotto() - item.getPrezzoScontato())}</p>
        </div>
    ...
    <c:choose>
        ...
        <div class="paga">
            <h2 class="text reveal">Il totale provvisorio è: ${totale} €
                <form action="pagamentoAvvenuto.html">
